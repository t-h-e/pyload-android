...
public class ServiceException extends TException implements org.apache.thrift.TBase<ServiceException, ServiceException._Fields>, java.io.Serializable, Cloneable, Comparable<ServiceException>, android.os.Parcelable {
    ...
    public ServiceException(android.os.Parcel in) {
        this.msg = in.readString();
    }

    public static final android.os.Parcelable.Creator<ServiceException> CREATOR = new android.os.Parcelable.Creator<ServiceException>() {
        @Override
        ...
        @Override
        public ServiceException createFromParcel(android.os.Parcel in) {
