...
public class ConfigSection implements org.apache.thrift.TBase<ConfigSection, ConfigSection._Fields>, java.io.Serializable, Cloneable, Comparable<ConfigSection>, android.os.Parcelable {
    ...
    public ConfigSection(android.os.Parcel in) {
        this.name = in.readString();
        this.description = in.readString();
        this.items = new ArrayList<ConfigItem>();
        in.readTypedList(this.items, ConfigItem.CREATOR);
        this.outline = in.readString();
    }

    public static final android.os.Parcelable.Creator<ConfigSection> CREATOR = new android.os.Parcelable.Creator<ConfigSection>() {
        @Override
        ...
        @Override
        public ConfigSection createFromParcel(android.os.Parcel in) {
    ...
    private static final _Fields optionals[] = {_Fields.OUTLINE};
    ...
    public ConfigSection(ConfigSection other) {
        ...
        if (other.isSetItems()) {
            List<ConfigItem> __this__items = new ArrayList<ConfigItem>(other.items.size());
